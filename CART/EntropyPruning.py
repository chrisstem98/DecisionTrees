# ===============================================
# Bullet 4 – CART (Entropy, pruning with ccp_alpha=0.1, with visualization)
# ===============================================
...
sns.heatmap(cm, annot=True, fmt="d", cmap="Purples", xticklabels=clf.classes_, yticklabels=clf.classes_)
plt.title("Confusion Matrix – CART (Entropy, Pruned ccp_alpha=0.1)")
...
plt.title("Feature Importance – CART (Entropy, Pruned ccp_alpha=0.1)")
plt.tight_layout()
plt.show()
...
plt.title("Decision Tree Visualization – CART (Entropy, Pruned ccp_alpha=0.1)")
plt.show()
...
# ---------- Print Results ----------
print("\n=== Bullet 4 Results: CART (Entropy, Pruning ccp_alpha=0.1) ===")
